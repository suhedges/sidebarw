        ...
        function goBack() {
            ...
            backArrow.classList.add('animate-click');

            backArrow.addEventListener('animationend', function handler() {
                backArrow.classList.remove('animate-click');
                backArrow.removeEventListener('animationend', handler);
